...
LDD_USB_TSDP                    pSDP;
uint_8 app_buff_ep3[16]; /* buffer for endpoint 3*/
uint_8 app_buff_ep1[16]; /* buffer for endpoint 1*/
uint_8 app_buff_ep2[16]; /* buffer for endpoint 2*/

/* array contains buffers for endpoints */
uint_8* app_buff_ep[] = {
                        app_buff_ep3,
                        app_buff_ep1,
                        app_buff_ep2,
...
uint_8 USB_DCI_Init_EndPoint(uint_8 controller_ID, USB_EP_STRUCT_PTR ep_ptr, boolean flag)
{
    ...
    else
    {
        ...
        bdt_elem->app_buffer = app_buff_ep[ep_ptr->ep_num - 1];
