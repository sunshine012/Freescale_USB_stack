...
#elif SD_CARD_APP
    		SD_Card_Info((uint_32_ptr)&device_lba_info_ptr->total_lba_device_supports,
    		    (uint_32_ptr)&device_lba_info_ptr->length_of_each_lba_of_device);
#endif
