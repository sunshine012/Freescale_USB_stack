...
**     Date/Time   : 2012-11-20, 11:06, # CodeGen: 92
**     Abstract    :
**
**     Settings    :
**
...
void __initialize_hardware(void)
{
  ...
  /* MXC_PTBPF1: B7=0 */
  MXC_PTBPF1 &= (uint8_t)~(uint8_t)0xF0U;                           
  /* MXC_PTCPF4: C0=0 */
  MXC_PTCPF4 &= (uint8_t)~(uint8_t)0x0FU;                           
  /* SIM_SCGC5: OSC1=1 */
  SIM_SCGC5 |= (uint8_t)0x02U;                            
  /* SIM_OSC1: OSC1EN=1,??=0,??=0,OSC1RANGE=2,OSC1HGO=0,OSC1EREFS=1,??=0 */
  SIM_OSC1 = (uint8_t)0x92U;           /*  Initialize OSC1 */
  /* OSC1_CR: ERCLKEN=1,??=0,EREFSTEN=0,??=0,SC2P=0,SC4P=0,SC8P=0,SC16P=0 */
  OSC1_CR = (uint8_t)0x80U;            /*  Setup OSC1 */
...
void PE_low_level_init(void)
{
  ...
  /* MXC_PTAPF4: A0=4 */
  MXC_PTAPF4 = (uint8_t)((MXC_PTAPF4 & (uint8_t)~(uint8_t)0x0BU) | (uint8_t)0x04U);
  /* MXC_PTBPF4: B0=5 */
  MXC_PTBPF4 = (uint8_t)((MXC_PTBPF4 & (uint8_t)~(uint8_t)0x0AU) | (uint8_t)0x05U);
  /* MXC_PTBPF2: B4=2 */
  ...
  /* INTC_IMRL: IMR17=0,IMR16=0,IMR15=0,IMR14=0,IMR13=0,IMR12=0,IMR11=1,IMR1=0,IMR0=0 */
  INTC_IMRL = (uint32_t)((INTC_IMRL & (uint32_t)~0x0003F003UL) | (uint32_t)0x0800UL);
...
/* Write code here ... */
  ...
  (void)UART_Init(NULL);
  /* ### TimerUnit_LDD "MTIM0" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  (void)MTIM0_Init(NULL);
  /* ### Init_FTM "PWM" init code ... */
  PWM_Init();
  /* ### Init_IRQ "PTB0" init code ... */
  PTB0_Init();
