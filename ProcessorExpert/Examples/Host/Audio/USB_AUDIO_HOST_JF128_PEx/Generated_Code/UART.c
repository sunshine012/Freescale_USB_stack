...
**     Version     : Component 01.159, Driver 01.09, CPU db: 3.00.000
...
**            Clock configuration 8                        : This component disabled
**     Contents    :
...
LDD_TDeviceData* UART_Init(LDD_TUserData *UserDataPtr)
{
  ...
  UART0_C4 = (uint8_t)0x00U;           /*  Set the C4 register */
...
static void InterruptRx(UART_TDeviceDataPtr DeviceDataPrv)
{
  ...
  Data = (uint16_t)UART_PDD_GetChar8(UART0_BASE_PTR); /* Read 8-bit character from receiver */
