...
**     Date/Time   : 2012-11-19, 16:25, # CodeGen: 89
**     Abstract    :
...
**                Interrupt transfers                      : no
**                Isochronous transfers                    : yes
**            Initialization                               : 
    ...
    if (Res == ERR_OK) {                                   /* Empty pipe descriptor found? */
      switch (PipeInitParamsPtr->TransferType) {
        case LDD_USB_CONTROL:                              /* Control pipe? */
          ...
          break;
        case LDD_USB_ISOCHRONOUS:                          /* Isochronous pipe? */
          ...
          PipePtr->EpCtrlRegVal = 0x5CU;                   /* Remember value for EP control register */
          break;
        default:
          Res = ERR_PARAM_ID;
          break;
