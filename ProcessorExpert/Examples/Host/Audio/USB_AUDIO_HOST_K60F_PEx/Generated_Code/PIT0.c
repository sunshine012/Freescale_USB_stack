...
static PIT0_TDeviceDataPtr INT_PIT0__DEFAULT_RTOS_ISRPARAM;
...
LDD_TDeviceData* PIT0_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* PIT_LDVAL0: TSV=0x1D4B */
  PIT_LDVAL0 = PIT_LDVAL_TSV(0x1D4B);  /* Set up load register */
  /* NVICIP68: PRI68=0 */
  NVICIP68 = 0x00U;                                                   
...
PE_ISR(PIT0_Interrupt)
{
  ...
  PIT0_TDeviceDataPtr DeviceDataPrv = INT_PIT0__DEFAULT_RTOS_ISRPARAM;
