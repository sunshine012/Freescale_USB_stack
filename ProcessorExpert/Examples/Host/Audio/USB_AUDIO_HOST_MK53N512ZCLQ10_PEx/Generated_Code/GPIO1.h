...
**     Date/Time   : 2013-03-04, 16:34, # CodeGen: 14
**     Abstract    :
...
#define GPIO1_ALLOCATED_PINS_MASK 0x20U /* Mask of all allocated pins from the port */
...
#define GPIO1_FIELD_0_PIN_0 LDD_GPIO_PIN_5 /* Constant for the pin in the field used in the method ConnectPin */
#define GPIO1_PLAY_START_BIT 5u        /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_PLAY_MASK 0x20u          /* Mask of the bits allocated by the bit field (within the port) */
