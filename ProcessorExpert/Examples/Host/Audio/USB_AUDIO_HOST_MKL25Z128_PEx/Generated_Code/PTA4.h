...
#define PTA4_PRPH_BASE_ADDRESS  0x400FF000U
  
/* Device data structure pointer used when auto initialization property is enabled. This constant can be passed as a first parameter to all component's methods. */
#define PTA4_DeviceData  ((LDD_TDeviceData *)PE_LDD_GetDeviceStructure(PE_LDD_COMPONENT_PTA4_ID))

/* Methods configuration constants - generated for all enabled component's methods */
#define PTA4_Init_METHOD_ENABLED
#define PTA4_Deinit_METHOD_ENABLED
#define PTA4_SetFieldValue_METHOD_ENABLED
#define PTA4_GetFieldValue_METHOD_ENABLED
#define PTA4_ClearFieldBits_METHOD_ENABLED
#define PTA4_SetFieldBits_METHOD_ENABLED
#define PTA4_ToggleFieldBits_METHOD_ENABLED
#define PTA4_SetFieldInputDirection_METHOD_ENABLED
#define PTA4_SetFieldOutputDirection_METHOD_ENABLED
#define PTA4_ConnectPin_METHOD_ENABLED

/* Events configuration constants - generated for all enabled component's events */
#define PTA4_OnPortEvent_EVENT_ENABLED

/* Definition of bit field constants */
#define PLAY ((LDD_GPIO_TBitField)0)

/* Definition of implementation constants */
#define PTA4_ALLOCATED_PINS_MASK 0x10U /* Mask of all allocated pins from the port */
#define PTA4_MODULE_BASE_ADDRESS FPTA_BASE_PTR /* Name of macro used as the base address */
#define PTA4_PORTCONTROL_BASE_ADDRESS PORTA_BASE_PTR /* Name of macro used as the base address */
#define PTA4_AVAILABLE_EVENTS_MASK LDD_GPIO_ON_PORT_EVENT /* Mask of all available events */
#define PTA4_FIELD_0_PIN_0 LDD_GPIO_PIN_4 /* Constant for the pin in the field used in the method ConnectPin */
#define PTA4_PLAY_START_BIT 4u         /* Index of the starting bit of the bit field (0 represents LSB) */
#define PTA4_PLAY_MASK 0x10u           /* Mask of the bits allocated by the bit field (within the port) */
...
typedef uint32_t PTA4_TPortValue;
...
typedef PTA4_TPortValue PTA4_TFieldValue;
