...
#define GPIO1_ALLOCATED_PINS_MASK 0x00080000U /* Mask of all allocated pins from the port */
...
#define GPIO1_FIELD_0_PIN_0 LDD_GPIO_PIN_19 /* Constant for the pin in the field used in the method ConnectPin */
#define GPIO1_PLAY_START_BIT 19u       /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_PLAY_MASK 0x00080000u    /* Mask of the bits allocated by the bit field (within the port) */
