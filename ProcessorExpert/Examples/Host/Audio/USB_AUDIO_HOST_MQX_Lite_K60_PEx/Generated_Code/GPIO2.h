...
#define GPIO2_ALLOCATED_PINS_MASK 0x04000000U /* Mask of all allocated pins from the port */
...
#define GPIO2_FIELD_0_PIN_0 LDD_GPIO_PIN_26 /* Constant for the pin in the field used in the method ConnectPin */
#define GPIO2_MUTE_START_BIT 26u       /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO2_MUTE_MASK 0x04000000u    /* Mask of the bits allocated by the bit field (within the port) */
