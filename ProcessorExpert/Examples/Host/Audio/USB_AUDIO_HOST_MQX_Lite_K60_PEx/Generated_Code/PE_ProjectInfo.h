...
#define  _PWM_Init
#define  _GPIO1_Init
#define  _GPIO1_Deinit
#define  _GPIO1_SetFieldValue
#define  _GPIO1_GetFieldValue
#define  _GPIO1_ClearFieldBits
#define  _GPIO1_SetFieldBits
#define  _GPIO1_ToggleFieldBits
#define  _GPIO1_SetFieldInputDirection
#define  _GPIO1_SetFieldOutputDirection
#define  _GPIO1_ConnectPin
#define  _GPIO2_Init
#define  _GPIO2_Deinit
#define  _GPIO2_SetFieldValue
#define  _GPIO2_GetFieldValue
#define  _GPIO2_ClearFieldBits
#define  _GPIO2_SetFieldBits
#define  _GPIO2_ToggleFieldBits
#define  _GPIO2_SetFieldInputDirection
#define  _GPIO2_SetFieldOutputDirection
#define  _GPIO2_ConnectPin
#define  _Sampling_TM_Enable
#define  _Sampling_TM_Disable
#define  _TU1_Init
#define  _TU1_Deinit
#define  _TU1_Enable
#define  _TU1_Disable
...
#define  _GPIO1_OnPortEvent
#define  _GPIO2_OnPortEvent
#define  _Sampling_TM_OnInterrupt
#define  _TU1_OnCounterRestart
...
#define  _PWM_PinChan0_PTC1_SPI0_PCS3_UART1_RTS_b_FTM0_CH0_FB_AD13_ADC0_SE15_TSI0_CH14
#define  _PWM_PinChan0_STR "PTC1_SPI0_PCS3_UART1_RTS_b_FTM0_CH0_FB_AD13_ADC0_SE15_TSI0_CH14"
...
/* BEAN GPIO1 PROPERTIES CONFIGURATION */
#define  _GPIO1_BeanTypeName_GPIO_LDD
#define  _GPIO1_BeanTypeName_STR "GPIO_LDD"
#define  _GPIO1_DeviceName_GPIO1
#define  _GPIO1_DeviceName_STR "GPIO1"
#define  _GPIO1_Port_PTA
#define  _GPIO1_Port_STR "PTA"
#define  _GPIO1_PortWidthProp_32_bits
#define  _GPIO1_PortWidthProp_STR "32_bits"
#define  _GPIO1_AllocatedPinsMaskProp_524288
#define  _GPIO1_AllocatedPinsMaskProp_STR "524288"
#define  _GPIO1_ReentrantMethods FALSE
#define  _GPIO1_ReentrantMethods_no
#define  _GPIO1_IntService TRUE
#define  _GPIO1_IntService_Enabled
#define  _GPIO1_PortInterrupt_INT_PORTA
#define  _GPIO1_PortInterrupt_STR "INT_PORTA"
#define  _GPIO1_PortInterruptPriority_0
#define  _GPIO1_PortInterruptPriority_STR "0"
#define  _GPIO1_BitFields_1
#define  _GPIO1_BitFields_STR "1"
#define  _GPIO1_BitFields_NUMITEMS 1
#define  _GPIO1_FieldName0_PLAY
#define  _GPIO1_FieldName0_STR "PLAY"
#define  _GPIO1_FieldMaskProp0_524288
#define  _GPIO1_FieldMaskProp0_STR "524288"
#define  _GPIO1_FieldStartBit0 19
#define  _GPIO1_AllocatedPins0_1
#define  _GPIO1_AllocatedPins0_STR "1"
#define  _GPIO1_AllocatedPins0_NUMITEMS 1
#define  _GPIO1_Pin0_0_PTA19_FTM1_FLT0_FTM_CLKIN1_LPT0_ALT1_XTAL
#define  _GPIO1_Pin0_0_STR "PTA19_FTM1_FLT0_FTM_CLKIN1_LPT0_ALT1_XTAL"
#define  _GPIO1_Pin0_0_BITNUM 19
#define  _GPIO1_PinSignal0_0_
#define  _GPIO1_PinFieldIndexProp0_0_0
#define  _GPIO1_PinFieldIndexProp0_0_STR "0"
#define  _GPIO1_PinIndexProp0_0_19
#define  _GPIO1_PinIndexProp0_0_STR "19"
#define  _GPIO1_PinFieldMaskProp0_0_1
#define  _GPIO1_PinFieldMaskProp0_0_STR "1"
#define  _GPIO1_PinMaskProp0_0_524288
#define  _GPIO1_PinMaskProp0_0_STR "524288"
#define  _GPIO1_InitPinDirection0_0 FALSE
#define  _GPIO1_InitPinDirection0_0_Input
#define  _GPIO1_InitialInterrupt0_0_Rising
#define  _GPIO1_InitialInterrupt0_0_STR "Rising"
#define  _GPIO1_LockInitSupport0_0_
#define  _GPIO1_Lock0_0 FALSE
#define  _GPIO1_Lock0_0_no
#define  _GPIO1_AutoInitializationGrp_1
#define  _GPIO1_AutoInitializationGrp_STR "1"
#define  _GPIO1_AutoInitialization TRUE
#define  _GPIO1_AutoInitialization_yes
#define  _GPIO1_OnPortEventInitState TRUE
#define  _GPIO1_OnPortEventInitState_Enabled
/* BEAN GPIO2 PROPERTIES CONFIGURATION */
#define  _GPIO2_BeanTypeName_GPIO_LDD
#define  _GPIO2_BeanTypeName_STR "GPIO_LDD"
#define  _GPIO2_DeviceName_GPIO2
#define  _GPIO2_DeviceName_STR "GPIO2"
#define  _GPIO2_Port_PTE
#define  _GPIO2_Port_STR "PTE"
#define  _GPIO2_PortWidthProp_32_bits
#define  _GPIO2_PortWidthProp_STR "32_bits"
#define  _GPIO2_AllocatedPinsMaskProp_67108864
#define  _GPIO2_AllocatedPinsMaskProp_STR "67108864"
#define  _GPIO2_ReentrantMethods FALSE
#define  _GPIO2_ReentrantMethods_no
#define  _GPIO2_IntService TRUE
#define  _GPIO2_IntService_Enabled
#define  _GPIO2_PortInterrupt_INT_PORTE
#define  _GPIO2_PortInterrupt_STR "INT_PORTE"
#define  _GPIO2_PortInterruptPriority_1
#define  _GPIO2_PortInterruptPriority_STR "1"
#define  _GPIO2_BitFields_1
#define  _GPIO2_BitFields_STR "1"
#define  _GPIO2_BitFields_NUMITEMS 1
#define  _GPIO2_FieldName0_MUTE
#define  _GPIO2_FieldName0_STR "MUTE"
#define  _GPIO2_FieldMaskProp0_67108864
#define  _GPIO2_FieldMaskProp0_STR "67108864"
#define  _GPIO2_FieldStartBit0 26
#define  _GPIO2_AllocatedPins0_1
#define  _GPIO2_AllocatedPins0_STR "1"
#define  _GPIO2_AllocatedPins0_NUMITEMS 1
#define  _GPIO2_Pin0_0_PTE26_UART4_CTS_b_ENET_1588_CLKIN_RTC_CLKOUT_USB_CLKIN
#define  _GPIO2_Pin0_0_STR "PTE26_UART4_CTS_b_ENET_1588_CLKIN_RTC_CLKOUT_USB_CLKIN"
#define  _GPIO2_Pin0_0_BITNUM 26
#define  _GPIO2_PinSignal0_0_
#define  _GPIO2_PinFieldIndexProp0_0_0
#define  _GPIO2_PinFieldIndexProp0_0_STR "0"
#define  _GPIO2_PinIndexProp0_0_26
#define  _GPIO2_PinIndexProp0_0_STR "26"
#define  _GPIO2_PinFieldMaskProp0_0_1
#define  _GPIO2_PinFieldMaskProp0_0_STR "1"
#define  _GPIO2_PinMaskProp0_0_67108864
#define  _GPIO2_PinMaskProp0_0_STR "67108864"
#define  _GPIO2_InitPinDirection0_0 FALSE
#define  _GPIO2_InitPinDirection0_0_Input
#define  _GPIO2_InitialInterrupt0_0_Rising
#define  _GPIO2_InitialInterrupt0_0_STR "Rising"
#define  _GPIO2_LockInitSupport0_0_
#define  _GPIO2_Lock0_0 FALSE
#define  _GPIO2_Lock0_0_no
#define  _GPIO2_AutoInitializationGrp_1
#define  _GPIO2_AutoInitializationGrp_STR "1"
#define  _GPIO2_AutoInitialization TRUE
#define  _GPIO2_AutoInitialization_yes
#define  _GPIO2_OnPortEventInitState TRUE
#define  _GPIO2_OnPortEventInitState_Enabled
/* BEAN Sampling_TM PROPERTIES CONFIGURATION */
#define  _Sampling_TM_BeanTypeName_TimerInt
#define  _Sampling_TM_BeanTypeName_STR "TimerInt"
#define  _Sampling_TM_DeviceName_Sampling_TM
#define  _Sampling_TM_DeviceName_STR "Sampling_TM"
#define  _Sampling_TM__Cmp_PIT_LDVAL0
#define  _Sampling_TM__Cmp_STR "PIT_LDVAL0"
#define  _Sampling_TM_Tmr_PIT_CVAL0
#define  _Sampling_TM_Tmr_STR "PIT_CVAL0"
#define  _Sampling_TM_FeatureCondGrpLDD_
#define  _Sampling_TM_InheritedComponent_TimerIntLdd1
#define  _Sampling_TM_InheritedComponent_STR "TimerIntLdd1"
#define  _Sampling_TM_IntService TRUE
#define  _Sampling_TM_IntService_Enabled
#define  _Sampling_TM_CmpInt_INT_PIT0
#define  _Sampling_TM_CmpInt_STR "INT_PIT0"
#define  _Sampling_TM_CmpInitPriority_8
#define  _Sampling_TM_CmpInitPriority_STR "8"
#define  _Sampling_TM_InitPrescaler_Auto_selected_prescaler
#define  _Sampling_TM_InitPrescaler_STR "Auto_selected_prescaler"
#define  _Sampling_TM__Tmg_value 125.0F /* This is timing required by the user - may not match with the set value */
#define  _Sampling_TM__Tmg_unit us     /* This is timing required by the user - may not match with the set value */
#define  _Sampling_TM__Tmg_unit_us     /* This is timing required by the user - may not match with the set value */
#define  _Sampling_TM__Tmg_valueSetHigh 125.0F /* Value set by PE timing model in units: us/Hz/baud/ticks/bit_s - according to requirements */
#define  _Sampling_TM__Tmg_unitSetHigh us /* Value set by PE timing model in units: us/Hz/baud/ticks/bit_s - according to requirements */
#define  _Sampling_TM__Tmg_unitSetHigh_us /* Value set by PE timing model in units: us/Hz/baud/ticks/bit_s - according to requirements */
#define  _Sampling_TM__Tmg_0_CompareValueHigh 6000
#define  _Sampling_TM__Tmg_NumTimingItems 1
#define  _Sampling_TM__Tmg_RuntimeSetting 0 /*none*/
#define  _Sampling_TM_SameValuesInAllModes TRUE
#define  _Sampling_TM_SameValuesInAllModes_yes
#define  _Sampling_TM_EntireTimer FALSE
#define  _Sampling_TM_EntireTimer_no
#define  _Sampling_TM_InitEnable TRUE
#define  _Sampling_TM_InitEnable_yes
#define  _Sampling_TM_InitEnableEvent TRUE
#define  _Sampling_TM_InitEnableEvent_yes
#define  _Sampling_TM_HighSpeed_0
#define  _Sampling_TM_HighSpeed_STR "0"
#define  _Sampling_TM_LowSpeed_1
#define  _Sampling_TM_LowSpeed_STR "1"
#define  _Sampling_TM_SlowSpeed_1
#define  _Sampling_TM_SlowSpeed_STR "1"
/* BEAN TU1 PROPERTIES CONFIGURATION */
#define  _TU1_BeanTypeName_TimerUnit_LDD
#define  _TU1_BeanTypeName_STR "TimerUnit_LDD"
#define  _TU1_DeviceName_TU1
#define  _TU1_DeviceName_STR "TU1"
#define  _TU1_MainModule_PIT
#define  _TU1_MainModule_STR "PIT"
#define  _TU1_Counter_PIT_CVAL0
#define  _TU1_Counter_STR "PIT_CVAL0"
#define  _TU1_CounterDir_1
#define  _TU1_CounterDir_STR "1"
#define  _TU1_CntWidth_32_bits
#define  _TU1_CntWidth_STR "32_bits"
#define  _TU1_ValueType_1
#define  _TU1_ValueType_STR "1"
#define  _TU1_InputClock_0
#define  _TU1_InputClock_STR "0"
#define  _TU1_TmgCounter_value 48.0F   /* This is timing required by the user - may not match with the set value */
#define  _TU1_TmgCounter_unit MHz      /* This is timing required by the user - may not match with the set value */
#define  _TU1_TmgCounter_unit_MHz      /* This is timing required by the user - may not match with the set value */
#define  _TU1_TmgCounter_valueSet 48000000.0F /* Value set by PE timing model in units: us/Hz/baud/ticks/bit_s - according to requirements */
#define  _TU1_TmgCounter_unitSet Hz    /* Value set by PE timing model in units: us/Hz/baud/ticks/bit_s - according to requirements */
#define  _TU1_TmgCounter_unitSet_Hz    /* Value set by PE timing model in units: us/Hz/baud/ticks/bit_s - according to requirements */
#define  _TU1_TmgCounter_NumTimingItems 1
#define  _TU1_CounterRestart_1
#define  _TU1_CounterRestart_STR "1"
#define  _TU1_PeriodDevice_PIT_LDVAL0
#define  _TU1_PeriodDevice_STR "PIT_LDVAL0"
#define  _TU1_Tmg_Period_value 125.0F  /* This is timing required by the user - may not match with the set value */
#define  _TU1_Tmg_Period_unit us       /* This is timing required by the user - may not match with the set value */
#define  _TU1_Tmg_Period_unit_us       /* This is timing required by the user - may not match with the set value */
#define  _TU1_Tmg_Period_valueSet 125.0F /* Value set by PE timing model in units: us/Hz/baud/ticks/bit_s - according to requirements */
#define  _TU1_Tmg_Period_unitSet us    /* Value set by PE timing model in units: us/Hz/baud/ticks/bit_s - according to requirements */
#define  _TU1_Tmg_Period_unitSet_us    /* Value set by PE timing model in units: us/Hz/baud/ticks/bit_s - according to requirements */
#define  _TU1_Tmg_Period_0_CompareValue 6000
#define  _TU1_Tmg_Period_NumTimingItems 1
#define  _TU1_IntServiceCounter TRUE
#define  _TU1_IntServiceCounter_Enabled
#define  _TU1_ModuloInt_INT_PIT0
#define  _TU1_ModuloInt_STR "INT_PIT0"
#define  _TU1_ModuloInitPriority_8
#define  _TU1_ModuloInitPriority_STR "8"
#define  _TU1_ChannelList_0
#define  _TU1_ChannelList_STR "0"
#define  _TU1_ChannelList_NUMITEMS 0
#define  _TU1_InitEnable TRUE
#define  _TU1_InitEnable_yes
#define  _TU1_AutoInitializationGrp_1
#define  _TU1_AutoInitializationGrp_STR "1"
#define  _TU1_AutoInitialization FALSE
#define  _TU1_AutoInitialization_no
#define  _TU1_OnCounterRestartInitMask TRUE
#define  _TU1_OnCounterRestartInitMask_Enabled
#define  _TU1_OnChannel0InitMask FALSE
#define  _TU1_OnChannel0InitMask_Disabled
#define  _TU1_OnChannel1InitMask FALSE
#define  _TU1_OnChannel1InitMask_Disabled
#define  _TU1_OnChannel2InitMask FALSE
#define  _TU1_OnChannel2InitMask_Disabled
#define  _TU1_OnChannel3InitMask FALSE
#define  _TU1_OnChannel3InitMask_Disabled
#define  _TU1_OnChannel4InitMask FALSE
#define  _TU1_OnChannel4InitMask_Disabled
#define  _TU1_OnChannel5InitMask FALSE
#define  _TU1_OnChannel5InitMask_Disabled
#define  _TU1_OnChannel6InitMask FALSE
#define  _TU1_OnChannel6InitMask_Disabled
#define  _TU1_OnChannel7InitMask FALSE
#define  _TU1_OnChannel7InitMask_Disabled
#define  _TU1_ClockConfigGrp_1
#define  _TU1_ClockConfigGrp_STR "1"
#define  _TU1_SpeedMode0_0
#define  _TU1_SpeedMode0_STR "0"
#define  _TU1_SpeedMode1_1
#define  _TU1_SpeedMode1_STR "1"
#define  _TU1_SpeedMode2_1
#define  _TU1_SpeedMode2_STR "1"
#define  _TU1_SpeedMode3_0
#define  _TU1_SpeedMode3_STR "0"
#define  _TU1_SpeedMode4_0
#define  _TU1_SpeedMode4_STR "0"
#define  _TU1_SpeedMode5_0
#define  _TU1_SpeedMode5_STR "0"
#define  _TU1_SpeedMode6_0
#define  _TU1_SpeedMode6_STR "0"
#define  _TU1_SpeedMode7_0
#define  _TU1_SpeedMode7_STR "0"
...
#define  _Cpu_IRCLKENCLKMode0 FALSE
#define  _Cpu_IRCLKENCLKMode0_Disabled
...
#define  _Cpu_IRCLKClkCLKMode0 0.0F
#define  _Cpu_IRCLKClkCLKMode0_STR "0.0"
#define  _Cpu_SystemOSCERCLKENCLKMode0 FALSE
#define  _Cpu_SystemOSCERCLKENCLKMode0_Disabled
#define  _Cpu_SystemOSCEREFSTENCLKMode0 FALSE
#define  _Cpu_SystemOSCEREFSTENCLKMode0_Disabled
#define  _Cpu_ERCLKClkCLKMode0 0.0F
#define  _Cpu_ERCLKClkCLKMode0_STR "0.0"
...
#define  _Cpu_IRCLKClkSpeedMode0_0
#define  _Cpu_IRCLKClkSpeedMode0_STR "0"
#define  _Cpu_ERCLKClkSpeedMode0_0
#define  _Cpu_ERCLKClkSpeedMode0_STR "0"
