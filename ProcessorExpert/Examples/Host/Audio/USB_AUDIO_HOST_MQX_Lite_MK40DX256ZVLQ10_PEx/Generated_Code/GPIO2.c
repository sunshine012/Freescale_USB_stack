...
LDD_TDeviceData* GPIO2_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->SavedISRSettings_PortInterrupt.isrFunction = _int_install_isr(LDD_ivIndex_INT_PORTC, Cpu_ivINT_PORTC, NULL);
...
void GPIO2_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)_int_install_isr(LDD_ivIndex_INT_PORTC, ((GPIO2_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings_PortInterrupt.isrFunction, ((GPIO2_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings_PortInterrupt.isrData);
