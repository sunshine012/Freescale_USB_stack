...
**     Date/Time   : 2013-01-15, 16:10, # CodeGen: 4
**     Abstract    :
**
**     Settings    :
**
...
/*
** ===================================================================
**     Method      :  Cpu_Cpu_ivINT_PORTC (component MK53N512LQ100)
**
**     Description :
...
** ===================================================================
*/
void Cpu_ivINT_PORTC(LDD_RTOS_TISRParameter _isrParameter)
{
  GPIO1_Interrupt(PE_LDD_GetDeviceStructure(PE_LDD_COMPONENT_GPIO1_ID)); /* Call the service routine */
  GPIO2_Interrupt(PE_LDD_GetDeviceStructure(PE_LDD_COMPONENT_GPIO2_ID)); /* Call the service routine */
}
...
/* Write code here ... */
  ...
  /* ### TimerInt "Sampling_TM" init code ... */
}
