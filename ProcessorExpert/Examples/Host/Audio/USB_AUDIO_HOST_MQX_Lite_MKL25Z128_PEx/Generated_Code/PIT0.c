...
**     Date/Time   : 2012-12-24, 10:03, # CodeGen: 89
**     Abstract    :
...
**         Deinit  - void PIT0_Deinit(LDD_TDeviceData *DeviceDataPtr);
...
typedef PIT0_TDeviceData *PIT0_TDeviceDataPtr; /* Pointer to the device data structure. */

/* {MQXLite RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static PIT0_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
...
LDD_TDeviceData* PIT0_Init(LDD_TUserData *UserDataPtr)
{
  ...
  PIT0_TDeviceData *DeviceDataPrv;
  ...
  DeviceDataPrv->SavedISRSettings_TUInterrupt.isrFunction = _int_install_isr(LDD_ivIndex_INT_PIT, PIT0_Interrupt, DeviceDataPrv);
  /* SIM_SCGC6: PIT=1 */
  ...
  /* PIT_LDVAL0: TSV=0x0BB7 */
  PIT_LDVAL0 = PIT_LDVAL_TSV(0x0BB7);  /* Set up load register */
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_PIT0_ID,DeviceDataPrv);
  return ((LDD_TDeviceData *)DeviceDataPrv); /* Return pointer to the device data structure */
}

/*
** ===================================================================
**     Method      :  PIT0_Deinit (component TimerUnit_LDD)
**
**     Description :
...
** ===================================================================
*/
void PIT0_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  PIT0_TDeviceData *DeviceDataPrv = (PIT0_TDeviceData *)DeviceDataPtr;
  ...
  (void)_int_install_isr(LDD_ivIndex_INT_PIT, ((PIT0_TDeviceDataPtr)DeviceDataPrv)->SavedISRSettings_TUInterrupt.isrFunction, ((PIT0_TDeviceDataPtr)DeviceDataPrv)->SavedISRSettings_TUInterrupt.isrData);
  PIT_PDD_ModuleClock(PIT_BASE_PTR, PIT_PDD_CLOCK_DISABLED);
  /* Unregistration of the device structure */
  PE_LDD_UnregisterDeviceStructure(PE_LDD_COMPONENT_PIT0_ID);
...
** ===================================================================
*/
void PIT0_Interrupt(LDD_RTOS_TISRParameter _isrParameter)
{
  /* {MQXLite RTOS Adapter} ISR parameter is passed as parameter from RTOS interrupt dispatcher */
  PIT0_TDeviceDataPtr DeviceDataPrv = (PIT0_TDeviceDataPtr)_isrParameter;

  PIT_PDD_ClearInterruptFlag(PIT_BASE_PTR, PIT_PDD_CHANNEL_0); /* Clear interrupt flag */
  PIT0_OnCounterRestart(DeviceDataPrv->UserDataPtr); /* Invoke OnCounterRestart event */
}
