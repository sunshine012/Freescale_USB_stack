...
static OTG_MAX3353_INT_PIN_TDeviceData * INT_PORTB__DEFAULT_RTOS_ISRPARAM;
/*
** ===================================================================
...
void OTG_MAX3353_INT_PIN_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  /* PORTB_PCR8: IRQC=0 */
  PORTB_PCR8 &= (uint32_t)~(uint32_t)(PORT_PCR_IRQC(0x0F));                                                   
  /* GPIOB_PDDR: PDD&=~0x0100 */
  GPIOB_PDDR &= (uint32_t)~(uint32_t)(GPIO_PDDR_PDD(0x0100));                                                   
...
LDD_TError OTG_MAX3353_INT_PIN_ConnectPin(LDD_TDeviceData *DeviceDataPtr, LDD_TPinMask PinMask)
{
  ...
  if ((PinMask & LDD_GPIO_PIN_8) != 0U) {
    clrSetReg32Bits(PORTB_PCR8, 0x01000600U, 0x0100U); /* MUX=0x01U */
  }
  return ERR_OK;
}
...
PE_ISR(OTG_MAX3353_INT_PIN_Interrupt)
{
  ...
  OTG_MAX3353_INT_PIN_TDeviceDataPtr DeviceDataPrv = INT_PORTB__DEFAULT_RTOS_ISRPARAM;
