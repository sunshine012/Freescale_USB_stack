...
** ###################################################################*/
  ...
  __attribute__ ((section (".vectortable"))) const tVectorTable __vect_table = { /* Interrupt vector table */
    ...
    (tIsrFunc)&Cpu_Interrupt,          /* 0x30  0x000000C0   -   ivINT_Reserved48              unused by PE */
    (tIsrFunc)&Cpu_Interrupt,          /* 0x31  0x000000C4   -   ivINT_Reserved49              unused by PE */
    (tIsrFunc)&Cpu_Interrupt,          /* 0x32  0x000000C8   -   ivINT_Reserved50              unused by PE */
    ...
    (tIsrFunc)&OTG_MAX3353_INT_PIN_Interrupt, /* 0x68  0x000001A0   8   ivINT_PORTB                   used by PE */
    (tIsrFunc)&PTC5_Interrupt,         /* 0x69  0x000001A4   0   ivINT_PORTC                   used by PE */
