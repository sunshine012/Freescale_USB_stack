...
/*
** ===================================================================
**     Method      :  _usb_host_register_ch9_callback (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_clear_feature (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_get_configuration (component USB_OTG_STACK)
**     Description :
**         Function to process standard device request in Chapter 9.
**         See Table 9-3 p. 250 of USB 2.0 specification.
**     Parameters  :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_get_descriptor (component USB_OTG_STACK)
**     Description :
**         Function to process standard device request in Chapter 9.
**         See Table 9-3 p. 250 of USB 2.0 specification.
**     Parameters  :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_get_interface (component USB_OTG_STACK)
**     Description :
**         Function to process standard device request in Chapter 9.
**         See Table 9-3 p. 250 of USB 2.0 specification.
**     Parameters  :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_get_status (component USB_OTG_STACK)
**     Description :
**         Function to process standard device request in Chapter 9.
**         See Table 9-3 p. 250 of USB 2.0 specification.
**     Parameters  :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_set_address (component USB_OTG_STACK)
**     Description :
**         Function to process standard device request in Chapter 9.
**         See Table 9-3 p. 250 of USB 2.0 specification.
**     Parameters  :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_set_configuration (component USB_OTG_STACK)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_set_descriptor (component USB_OTG_STACK)
**     Description :
**         Function to process standard device request in Chapter 9.
**         See Table 9-3 p. 250 of USB 2.0 specification.
**     Parameters  :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_set_feature (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_set_interface (component USB_OTG_STACK)
**     Description :
**         Function to process standard device request in Chapter 9.
**         See Table 9-3 p. 250 of USB 2.0 specification.
**     Parameters  :
...
/*
** ===================================================================
**     Method      :  _usb_host_ch9_synch_frame (component USB_OTG_STACK)
**     Description :
**         Function to process standard device request in Chapter 9.
**         See Table 9-3 p. 250 of USB 2.0 specification.
**     Parameters  :
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_cntrl_request (component USB_OTG_STACK)
**     Description :
