...
uint8_t Device_App_Task_task_stack[DEVICE_APP_TASK_TASK_STACK_SIZE];
uint8_t Host_App_Task_task_stack[HOST_APP_TASK_TASK_STACK_SIZE];
uint8_t OTG_App_Task_task_stack[OTG_APP_TASK_TASK_STACK_SIZE];

/* Task stacks array of pointers */
const uint8_t * mqx_task_stack_pointers[] = {
/* "Device_App_Task" task              */  Device_App_Task_task_stack,
/* "Host_App_Task" task                */  Host_App_Task_task_stack,
/* "OTG_App_Task" task                 */  OTG_App_Task_task_stack,
