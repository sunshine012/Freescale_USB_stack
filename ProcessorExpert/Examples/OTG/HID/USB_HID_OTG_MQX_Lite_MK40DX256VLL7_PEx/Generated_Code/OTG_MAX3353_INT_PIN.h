...
#define OTG_MAX3353_INT_PIN_ALLOCATED_PINS_MASK 0x80U /* Mask of all allocated pins from the port */
...
#define OTG_MAX3353_INT_PIN_FIELD_0_PIN_0 LDD_GPIO_PIN_7 /* Constant for the pin in the field used in the method ConnectPin */
#define OTG_MAX3353_INT_PIN_I2C_INT_START_BIT 7u /* Index of the starting bit of the bit field (0 represents LSB) */
#define OTG_MAX3353_INT_PIN_I2C_INT_MASK 0x80u /* Mask of the bits allocated by the bit field (within the port) */
