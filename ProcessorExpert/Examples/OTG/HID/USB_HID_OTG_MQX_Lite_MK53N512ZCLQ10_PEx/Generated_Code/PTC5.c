...
**     Date/Time   : 2013-02-28, 10:52, # CodeGen: 7
**     Abstract    :
...
LDD_TDeviceData* PTC5_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->SavedISRSettings_PortInterrupt.isrData = _int_get_isr_data(LDD_ivIndex_INT_PORTC);
  DeviceDataPrv->SavedISRSettings_PortInterrupt.isrFunction = _int_install_isr(LDD_ivIndex_INT_PORTC, PTC5_Interrupt, DeviceDataPrv);
  /* GPIOC_PDDR: PDD&=~0x20 */
...
void PTC5_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)_int_install_isr(LDD_ivIndex_INT_PORTC, ((PTC5_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings_PortInterrupt.isrFunction, ((PTC5_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings_PortInterrupt.isrData);
...
LDD_TError PTC5_SetPortEventCondition(LDD_TDeviceData *DeviceDataPtr, PTC5_TPortValue Mask, LDD_GPIO_TEventCondition Condition)
{
  ...
  if ((Mask & ((PTC5_TPortValue)(~((PTC5_TPortValue)PTC5_ALLOCATED_PINS_MASK)))) != 0U) { /* Check Mask parameter */
  ...
  while (Mask != 0x00U) {
    if ((Mask & 0x01U) != 0U) {
      PORT_PDD_SetPinInterruptConfiguration(PTC5_PORTCONTROL_BASE_ADDRESS, PinIndex, Condition); /* Set pin condition */
    }
    PinIndex++;
    Mask >>= 1;
  }
...
void PTC5_SetFieldValue(LDD_TDeviceData *DeviceDataPtr, LDD_GPIO_TBitField Field, PTC5_TFieldValue Value)
{
  ...
  switch (Field) {                     /* no break */
    case Page_Up: {                    /* bit field #0 */
      GPIO_PDD_SetPortDataOutput(PTC5_MODULE_BASE_ADDRESS,
        (
          GPIO_PDD_GetPortDataOutput(PTC5_MODULE_BASE_ADDRESS)
          & ((PTC5_TPortValue)(~((PTC5_TPortValue)PTC5_Page_Up_MASK)))
        )
        | (
          ((PTC5_TPortValue)(Value << PTC5_Page_Up_START_BIT))
          & ((PTC5_TPortValue)PTC5_Page_Up_MASK)
        )
      );
      break;
    }
  ...
  switch (Field) {                     /* no break */
    case Page_Up: {                    /* bit field #0 */
      GPIO_PDD_ClearPortDataOutputMask(PTC5_MODULE_BASE_ADDRESS,
        ((PTC5_TPortValue)PTC5_Page_Up_MASK)
        & ((PTC5_TPortValue)(Mask << PTC5_Page_Up_START_BIT))
      );
      break;
    }
    default:
...
** ===================================================================
*/
void PTC5_Interrupt(LDD_RTOS_TISRParameter _isrParameter)
{
  /* {MQXLite RTOS Adapter} ISR parameter is passed as parameter from RTOS interrupt dispatcher */
  PTC5_TDeviceDataPtr DeviceDataPrv = (PTC5_TDeviceDataPtr)_isrParameter;
