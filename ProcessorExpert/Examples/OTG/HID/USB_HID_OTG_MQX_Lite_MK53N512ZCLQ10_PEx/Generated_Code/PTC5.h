...
#define PTC5_Page_Up_START_BIT 5u      /* Index of the starting bit of the bit field (0 represents LSB) */
#define PTC5_Page_Up_MASK 0x20u        /* Mask of the bits allocated by the bit field (within the port) */
