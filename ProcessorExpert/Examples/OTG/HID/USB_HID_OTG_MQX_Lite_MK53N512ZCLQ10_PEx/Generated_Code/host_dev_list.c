...
/* buffer for device list */
uint_8 g_dev_list_buff[MAX_DEV_LIST][MAX_DEV_LIST_BUFF_SIZE];
uint_8 g_dev_list_index = 0;
/* buffer for attachdevice list  */
uint_8 g_dev_list_attach_buff[MAX_DEV_ATTACH][sizeof(DEV_INSTANCE)];
uint_8 g_dev_list_attach_index = 0;
...
{ /* Body */
    ...
    mem_ptr = (DEV_MEMORY_PTR)g_dev_list_buff[g_dev_list_index];
    g_dev_list_index++;
    if (mem_ptr == NULL) {
...
/*
** ===================================================================
**     Method      :  usb_dev_list_attach_device (component USB_OTG_STACK)
**     Description :
...
USB_STATUS usb_dev_list_attach_device(_usb_host_handle handle, uint_8 speed, uint_8 hub_no, uint_8 port_no)
{
    ...
    dev_instance_ptr = (DEV_INSTANCE_PTR)g_dev_list_attach_buff[g_dev_list_attach_index];
    g_dev_list_attach_index++;
    ...
    if (dev_instance_ptr->address > 127) {
        ...
        USB_unlock();
        g_dev_list_attach_index--; /* free the dev_instance_ptr buffer */
