...
#define USB_KHCI_TASK_STACKSIZE            1200
...
/* buffer for transaction queue */
uint_32                 tr_que[(sizeof(LWMSGQ_STRUCT) + USBCFG_KHCI_TR_QUE_MSG_CNT * sizeof(TR_MSG_STRUCT)) / sizeof(_mqx_max_type) + 1];
/* buffer for khci task */
uint_8                 g_khci_stack[USB_KHCI_TASK_STACKSIZE];
/* the transaction index */
extern uint_8         g_new_tr_element_index;
/*****************************************************************************
* Local Types - None
*****************************************************************************/
...
/*
** ===================================================================
**     Method      :  _usb_khci_init_int_tr (component USB_OTG_STACK)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_khci_add_int_tr (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
/*
** ===================================================================
**     Method      :  _usb_khci_process_tr_complete (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
)
{
    ...
    g_new_tr_element_index = 0; /* release the buffer used by the TRs */
...
/*
** ===================================================================
**     Method      :  _usb_khci_rm_int_tr (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
/*
** ===================================================================
**     Method      :  _usb_khci_task_create (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
static USB_STATUS _usb_khci_task_create(_usb_host_handle handle) {
    ...
    task_template.CREATION_PARAMETER = (uint_32)handle;
    task_id = _task_create_at(0, 0, (uint_32)&task_template, g_khci_stack,USB_KHCI_TASK_STACKSIZE);
    usb_host_ptr->khci_task_id = task_id;
    if (task_id == 0) {
...
/*
** ===================================================================
**     Method      :  _usb_khci_init (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
)
{
    ...
    USB_HOST_STATE_STRUCT_PTR usb_host_ptr = (USB_HOST_STATE_STRUCT_PTR)handle;
    _lwmsgq_init(tr_que, USBCFG_KHCI_TR_QUE_MSG_CNT, MSG_SIZE_IN_MAX_TYPE);
    _usb_khci_init_int_tr();
    status = _lwevent_create(&khci_event, 0);
    if(status != MQX_OK)
    {
        return USBERR_GET_MEMORY_FAILED;
    }
    status = _usb_khci_task_create(usb_host_ptr);
    /* Create the ISR task */
    return status;
}
...
/*
** ===================================================================
**     Method      :  _usb_khci_shutdown (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
)
{
    USB_HOST_STATE_STRUCT_PTR usb_host_ptr = (USB_HOST_STATE_STRUCT_PTR)handle;
    USB_STATUS status;
    if(usb_host_ptr->khci_task_id)
    {
        status = _task_destroy(usb_host_ptr->khci_task_id);
        if(status != MQX_OK)
        {
             return USBERR_UNKNOWN_ERROR;
        }
    }
    status = _lwevent_destroy(&khci_event);
    if(status != MQX_OK)
    {
        return USBERR_UNKNOWN_ERROR;
    }
