...
LDD_TDeviceData* GPIO1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->SavedISRSettings_PortInterrupt.isrFunction = _int_install_isr(LDD_ivIndex_INT_PORTE, GPIO1_Interrupt, DeviceDataPrv);
...
void GPIO1_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)_int_install_isr(LDD_ivIndex_INT_PORTE, ((GPIO1_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings_PortInterrupt.isrFunction, ((GPIO1_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings_PortInterrupt.isrData);
    ...
    case Page_Up: {                    /* bit field #0 */
      GPIO_PDD_SetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS,
        (
          ...
          & ((GPIO1_TPortValue)(~((GPIO1_TPortValue)GPIO1_Page_Up_MASK)))
        )
        | (
          ((GPIO1_TPortValue)(Value << GPIO1_Page_Up_START_BIT))
          & ((GPIO1_TPortValue)GPIO1_Page_Up_MASK)
        )
      );
      break;
    }
  ...
  switch (Field) {                     /* no break */
    case Page_Up: {                    /* bit field #0 */
      GPIO_PDD_ClearPortDataOutputMask(GPIO1_MODULE_BASE_ADDRESS,
        ((GPIO1_TPortValue)GPIO1_Page_Up_MASK)
        & ((GPIO1_TPortValue)(Mask << GPIO1_Page_Up_START_BIT))
      );
      break;
    }
    default:
