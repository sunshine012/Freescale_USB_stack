...
**     Date/Time   : 2013-02-28, 08:52, # CodeGen: 109
**     Abstract    :
...
**         SetPortEventCondition   - LDD_TError OTG_MAX3353_INT_PIN_SetPortEventCondition(LDD_TDeviceData...
...
LDD_TDeviceData* OTG_MAX3353_INT_PIN_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->SavedISRSettings_PortInterrupt.isrFunction = _int_install_isr(LDD_ivIndex_INT_PORTA, OTG_MAX3353_INT_PIN_Interrupt, DeviceDataPrv);
  /* GPIOA_PDDR: PDD&=~0x04000000 */
  GPIOA_PDDR &= (uint32_t)~(uint32_t)(GPIO_PDDR_PDD(0x04000000));                                                   
  /* Initialization of Port Control registers */
  /* PORTA_PCR26: ISF=0,LK=0,MUX=1 */
...
void OTG_MAX3353_INT_PIN_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  /* PORTA_PCR26: IRQC=0 */
  PORTA_PCR26 &= (uint32_t)~(uint32_t)(PORT_PCR_IRQC(0x0F));                                                   
  /* GPIOA_PDDR: PDD&=~0x04000000 */
  GPIOA_PDDR &= (uint32_t)~(uint32_t)(GPIO_PDDR_PDD(0x04000000));                                                   
  ...
  (void)_int_install_isr(LDD_ivIndex_INT_PORTA, ((OTG_MAX3353_INT_PIN_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings_PortInterrupt.isrFunction, ((OTG_MAX3353_INT_PIN_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings_PortInterrupt.isrData);
...
/*
** ===================================================================
**     Method      :  OTG_MAX3353_INT_PIN_SetPortEventCondition (component GPIO_LDD)
**
**     Description :
...
** ===================================================================
*/
LDD_TError OTG_MAX3353_INT_PIN_SetPortEventCondition(LDD_TDeviceData *DeviceDataPtr, OTG_MAX3353_INT_PIN_TPortValue Mask, LDD_GPIO_TEventCondition Condition)
{
  uint8_t PinIndex = 0U;
  ...
  if ((Mask & ((OTG_MAX3353_INT_PIN_TPortValue)(~((OTG_MAX3353_INT_PIN_TPortValue)OTG_MAX3353_INT_PIN_ALLOCATED_PINS_MASK)))) != 0U) { /* Check Mask parameter */
  ...
  while (Mask != 0x00U) {
    if ((Mask & 0x01U) != 0U) {
      PORT_PDD_SetPinInterruptConfiguration(OTG_MAX3353_INT_PIN_PORTCONTROL_BASE_ADDRESS, PinIndex, Condition); /* Set pin condition */
    }
    PinIndex++;
    Mask >>= 1;
  }
...
LDD_TError OTG_MAX3353_INT_PIN_ConnectPin(LDD_TDeviceData *DeviceDataPtr, LDD_TPinMask PinMask)
{
  ...
  if ((PinMask & LDD_GPIO_PIN_26) != 0U) {
    clrSetReg32Bits(PORTA_PCR26, 0x01000600U, 0x0100U); /* MUX=0x01U */
  }
  return ERR_OK;
}
...
** ===================================================================
*/
void OTG_MAX3353_INT_PIN_Interrupt(LDD_RTOS_TISRParameter _isrParameter)
{
  /* {MQXLite RTOS Adapter} ISR parameter is passed as parameter from RTOS interrupt dispatcher */
  OTG_MAX3353_INT_PIN_TDeviceDataPtr DeviceDataPrv = (OTG_MAX3353_INT_PIN_TDeviceDataPtr)_isrParameter;
