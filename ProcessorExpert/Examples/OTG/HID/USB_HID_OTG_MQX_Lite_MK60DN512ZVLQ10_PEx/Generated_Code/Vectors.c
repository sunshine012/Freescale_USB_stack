...
**     Date/Time   : 2013-02-27, 18:31, # CodeGen: 106
**     Abstract    :
**
**     Settings    :
**
...
** ###################################################################*/
  ...
  __attribute__ ((section (".vectortable"))) const tVectorTable __vect_table = { /* Interrupt vector table */
    ...
    (tIsrFunc)&_int_kernel_isr,        /* 0x67  0x0000019C   8   ivINT_PORTA                    used by PE */
    ...
    (tIsrFunc)&_int_kernel_isr,        /* 0x6B  0x000001AC   0   ivINT_PORTE                    used by PE */
