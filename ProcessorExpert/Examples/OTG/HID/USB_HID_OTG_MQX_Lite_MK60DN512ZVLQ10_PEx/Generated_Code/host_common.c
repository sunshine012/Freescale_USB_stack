...
extern uint_8 g_dev_list_index; /* the index of the device list buffer */
/*FUNCTION*----------------------------------------------------------------
*
...
/*
** ===================================================================
**     Method      :  usb_hostdev_validate (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_get_buffer (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_get_descriptor (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_find_pipe_handle (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  usb_hostdev_get_pipe_handle (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  usb_host_class_intf_init (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  usb_host_class_intf_validate (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_host_driver_info_register (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_select_config (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_select_interface (component USB_OTG_STACK)
**     Description :
...
USB_STATUS _usb_hostdev_select_interface(_usb_device_instance_handle dev_handle, _usb_interface_descriptor_handle intf_handle, void* class_intf_ptr)
{
    ...
    for (ep_num = 1; ep_num <= intf->bNumEndpoints; ep_num++) {
        ...
        if (error != USB_OK) {
            ...
            g_dev_list_index--; /* release the device list buffer */
            goto BadExit;
        }
...
/*
** ===================================================================
**     Method      :  usb_hostdev_tr_init (component USB_OTG_STACK)
**     Description :
**         
**     Parameters  :
**         NAME            - DESCRIPTION
