...
#define GPIO1_ALLOCATED_PINS_MASK 0x10U /* Mask of all allocated pins from the port */
...
#define GPIO1_FIELD_0_PIN_0 LDD_GPIO_PIN_4 /* Constant for the pin in the field used in the method ConnectPin */
#define GPIO1_key_START_BIT 4u         /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_key_MASK 0x10u           /* Mask of the bits allocated by the bit field (within the port) */
