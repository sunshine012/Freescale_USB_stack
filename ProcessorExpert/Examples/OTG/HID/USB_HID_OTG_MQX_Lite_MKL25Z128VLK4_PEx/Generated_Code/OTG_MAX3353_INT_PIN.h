...
#define OTG_MAX3353_INT_PIN_PRPH_BASE_ADDRESS  0x400FF0C0U
...
#define OTG_MAX3353_INT_PIN_ALLOCATED_PINS_MASK 0x02U /* Mask of all allocated pins from the port */
#define OTG_MAX3353_INT_PIN_MODULE_BASE_ADDRESS FPTD_BASE_PTR /* Name of macro used as the base address */
#define OTG_MAX3353_INT_PIN_PORTCONTROL_BASE_ADDRESS PORTD_BASE_PTR /* Name of macro used as the base address */
#define OTG_MAX3353_INT_PIN_AVAILABLE_EVENTS_MASK LDD_GPIO_ON_PORT_EVENT /* Mask of all available events */
#define OTG_MAX3353_INT_PIN_FIELD_0_PIN_0 LDD_GPIO_PIN_1 /* Constant for the pin in the field used in the method ConnectPin */
#define OTG_MAX3353_INT_PIN_I2C_INT_START_BIT 1u /* Index of the starting bit of the bit field (0 represents LSB) */
#define OTG_MAX3353_INT_PIN_I2C_INT_MASK 0x02u /* Mask of the bits allocated by the bit field (within the port) */
