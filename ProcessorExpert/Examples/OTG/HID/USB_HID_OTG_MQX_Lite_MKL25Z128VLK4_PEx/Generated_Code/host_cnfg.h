...
#define MAX_HUB_NUM                                   (2)
/* maximum hub control buffer size */
#define MAX_HUB_CONTROL_BUFF_SIZE                     (128)
/* maximum hub interrupt buffer size */
#define MAX_HUB_INTERRUPT_BUFF_SIZE                   (128)
/* maximum hub port NR */
#define MAX_HUB_PORT_NR                               (1)
