...
/* buffer for packet_desc_pool*/
uint_8 g_packet_desc_pool_buff[sizeof (USB_ISO_PACKET_DESC_STRUCT) * MAX_NUM_DESCS];
/* buffer for host_init*/
uint_8 g_host_init_buff[sizeof(USB_HOST_STATE_STRUCT)];
/* buffer for host_register_service*/
uint_8 g_host_register_service_buff[MAX_HOST_REGISTER_SERVICE][sizeof(USB_SERVICE_STRUCT)];
uint_8 g_host_register_service_index = 0;
/* buffer for new_tr_element*/
uint_8 g_new_tr_element_buff[MAX_TR_ELEMENT][sizeof(PIPE_TR_STRUCT)];
uint_8 g_new_tr_element_index = 0;
/* buffer for pipe_descriptor_base*/
uint_8 g_pipe_descriptor_base_buff[(sizeof(PIPE_DESCRIPTOR_STRUCT)) *  USBCFG_MAX_PIPES];
...
)
{
    uchar_ptr   mem_ptr;
    uint_32     i;
    mem_ptr = g_packet_desc_pool_buff;
...
/*
** ===================================================================
**     Method      :  _usb_host_init (component USB_OTG_STACK)
**     Description :
...
USB_STATUS _usb_host_init(uint_8 devnum, uint_32 frame_list_size, _usb_host_handle _PTR_ hci_handle)
{
    ...
    usb_host_state_struct_ptr = (USB_HOST_STATE_STRUCT_PTR)g_host_init_buff;
...
*/
    ...
    usb_host_state_struct_ptr->PIPE_DESCRIPTOR_BASE_PTR =(PIPE_DESCRIPTOR_STRUCT_PTR)g_pipe_descriptor_base_buff;
...
/*
** ===================================================================
**     Method      :  _usb_host_register_service (component USB_OTG_STACK)
**     Description :
...
uint_32 _usb_host_register_service(_usb_host_handle hci_handle, uint_8 type, SERVICE_CALLBACK service)
{
    ...
    *search_ptr;
    ...
    service_ptr = (USB_SERVICE_STRUCT_PTR)g_host_register_service_buff[g_host_register_service_index];
    g_host_register_service_index++;
...
/*
** ===================================================================
**     Method      :  _usb_host_unregister_service (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_host_open_pipe (component USB_OTG_STACK)
**     Description :
...
{ /* Body */
    ...
    pipe_tr_ptr = (PIPE_TR_STRUCT_PTR)g_new_tr_element_buff[g_new_tr_element_index];
    g_new_tr_element_index++;
...
/*
** ===================================================================
**     Method      :  _usb_host_send_setup (component USB_OTG_STACK)
**     Description :
...
/*
** ===================================================================
**     Method      :  _usb_host_get_transfer_status (component USB_OTG_STACK)
**     Description :
