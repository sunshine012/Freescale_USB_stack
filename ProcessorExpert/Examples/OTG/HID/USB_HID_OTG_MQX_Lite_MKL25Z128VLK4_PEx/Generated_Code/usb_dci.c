...
LDD_USB_TSDP                           pSDP;
/* buffer for endpoint in */
uint_8 app_buff_ep_in1[16]; /* buffer for endpoint in 1*/

uint_8* app_buff_ep_in[] = {
                        NULL,
                        app_buff_ep_in1,
                        NULL,
                        NULL,
...
/* buffer for endpoint out */

uint_8* app_buff_ep_out[] = {
                        NULL,
                        NULL,
                        NULL,
                        NULL,
...
uint_8  USB_DCI_Init_EndPoint(uint_8 controller_ID, USB_EP_STRUCT_PTR ep_ptr, boolean flag)
{
    ...
    else
    {
        ...
        {
            bdt_elem->app_buffer = app_buff_ep_out[ep_ptr->ep_num];
        }
        else
        {
            bdt_elem->app_buffer = app_buff_ep_in[ep_ptr->ep_num];
        }
