...
/*
** ===================================================================
**     Method      :  USB_Device_Init_Params (component USB_OTG_STACK)
**
**     Description :
...
/*
    ** ===================================================================
    **     Method      :  _usb_device_init (component USB_OTG_STACK)
    **     Description :
...
**         NAME            - DESCRIPTION
    ...
    **                       USB_OK                              : When
    **                       Successful
    **                       USBERR_INVALID_NUM_OF_ENDPOINTS     : When
    **                       endpoints > max Supported
    ** ===================================================================
    */
uint_8  _usb_device_init(uint_8 device_number, _usb_device_handle _PTR_ handle, uint_8 number_of_endpoints)
{
    ...
    (sizeof(USB_SERVICE_CALLBACK) * USB_SERVICE_MAX),0);
...
/*
    ** ===================================================================
    **     Method      :  _usb_device_deinit (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  _usb_device_init_endpoint (component USB_OTG_STACK)
    **     Description :
...
**         NAME            - DESCRIPTION
    ...
    **                       USB_OK                              : When
    **                       Successful
    **                       USBERR_EP_INIT_FAILED     : When endpoints >
    **                       max Supported
    ** ===================================================================
    */
...
/*
    ** ===================================================================
    **     Method      :  _usb_device_deinit_endpoint (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  _usb_device_get_status (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  _usb_device_set_status (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  _usb_device_register_service (component USB_OTG_STACK)
    **     Description :
    **         This function registers a callback function from the
    **         application if it is called not already registered so that
    **         the registered callback function can be if the event of that
    **         type occurs
**     Parameters  :
**         NAME            - DESCRIPTION
    ...
    **                       USB_OK                              : When
    **                       Successful
    **                       USBERR_ALLOC_SERVICE     : When invalid
    **                       type or already registered
    ** ===================================================================
    */
...
/*
    ** ===================================================================
    **     Method      :  _usb_device_unregister_service (component USB_OTG_STACK)
    **     Description :
...
**         NAME            - DESCRIPTION
    ...
    **                       USB_OK                              : When
    **                       Successful
    **                       USBERR_UNKNOWN_ERROR     : When invalid
    **                       type or not registered
    ** ===================================================================
    */
...
/*
    ** ===================================================================
    **     Method      :  USB_Device_Call_Service (component USB_OTG_STACK)
    **     Description :
