...
/* buffer for host_hub_device */
uint_8 g_host_hub_device_buff[MAX_HUB_NUM][sizeof(HUB_DEVICE_STRUCT)];
uint_8 g_host_hub_device_index = 0;
/* buffer for hub_parser_control */
uint_8 g_hub_parser_control_buff[7];
/* buffer for hub_instance_control */
uint_8 g_hub_instance_control_buff[MAX_HUB_CONTROL_BUFF_SIZE];
/* buffer for hub_instance_interrupt */
uint_8 g_hub_instance_interrupt_buff[MAX_HUB_INTERRUPT_BUFF_SIZE];
/* buffer for hub_ports */
uint_8 g_hub_ports_buff[MAX_HUB_PORT_NR *  sizeof(HUB_PORT_STRUCT)];
/*
** ===================================================================
...
void usb_host_hub_device_event(_usb_device_instance_handle dev_handle, _usb_interface_descriptor_handle intf_handle, uint_32 event_code)
{
    ...
    case USB_ATTACH_EVENT: {
            ...
            new_hub = g_host_hub_device_buff[g_host_hub_device_index];
            g_host_hub_device_index++;
            if (NULL == new_hub){
                break;
            }
    ...
    case USB_INTF_EVENT: {
            ...
            if (hub_parser->INTF_HANDLE == intf_handle) {
                ...
                hub_parser->control_buffer = g_hub_parser_control_buff;
...
{ /* Body */
    ...
    case HUB_GET_DESCRIPTOR_TINY_PROCESS:
        {
            ...
            hub_instance->control_buffer = g_hub_instance_control_buff;
    ...
    case HUB_GET_DESCRIPTOR_PROCESS:
        {
            ...
            hub_instance->HUB_PORTS  = g_hub_ports_buff;
    ...
    case HUB_GET_PORT_STATUS_PROCESS:
        ...
        hub_instance->interrupt_buffer = g_hub_instance_interrupt_buff;
