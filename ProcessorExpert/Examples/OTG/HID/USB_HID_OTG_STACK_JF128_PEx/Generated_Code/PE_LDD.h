...
**     Date/Time   : 2012-11-19, 13:14, # CodeGen: 64
**     Abstract    :
**
**     Settings    :
**
...
#define PE_LDD_COMPONENT_OTG_MAX3353_INT_PIN_ID  0x02U
#define PE_LDD_COMPONENT_OTG_MAX3353_ID          0x03U
...
typedef enum {
  ...
  LDD_GPIO_LOW      = 0x06u,           /* Event when logic zero */
  LDD_GPIO_HIGH     = 0x07u,           /* Event when logic one */
  LDD_GPIO_FALLING  = 0x04u,           /* Event on falling edge */
  LDD_GPIO_RISING   = 0x05u,           /* Event on rising edge */
  LDD_GPIO_BOTH     = 0x08u            /* Event on rising and falling edge */
...
#define LDD_SSI_RX_SYNC_ERROR         0x02U /* Receiver frame sync error */
#define LDD_SSI_RX_DMA_ERROR          0x04U /* Receiver DMA error */

#define LDD_SSI_TX_UNDERFLOW          0x08U /* Transmitter underflow */
#define LDD_SSI_TX_SYNC_ERROR         0x10U /* Transmitter frame sync error */
#define LDD_SSI_TX_DMA_ERROR          0x20U /* Transmitter DMA error */
...
#define LDD_RTC_ALARM_ONCE_ONLY      0x00U /* Seconds, Minutes, Hours, Days, Months, and Year matched */
#define LDD_RTC_ALARM_ONCE_A_YEAR    0x01U /* Seconds, Minutes, Hours, Days and Months matched */
#define LDD_RTC_ALARM_ONCE_A_MONTH   0x02U /* Seconds, Minutes, Hours and Days matched */
#define LDD_RTC_ALARM_ONCE_A_DAY     0x03U /* Seconds, Minutes and Hours matched */

#define LDD_RTC_ON_ALARM             0x04U /* OnAlarm event mask */
#define LDD_RTC_ON_DAY               0x08U /* OnDay event mask */
#define LDD_RTC_ON_HOUR              0x10U /* OnHour event mask */
#define LDD_RTC_ON_MINUTE            0x20U /* OnMin event mask */
#define LDD_RTC_ON_SECOND            0x40U /* OnSecond event mask */
#define LDD_RTC_ON_2_HZ              0x80U /* On2Hz event mask */
#define LDD_RTC_ON_4_HZ              0x0100U /* On4Hz event mask */
#define LDD_RTC_ON_8_HZ              0x0200U /* On8Hz event mask */
#define LDD_RTC_ON_16_HZ             0x0400U /* On16Hz event mask */
#define LDD_RTC_ON_32_HZ             0x0800U /* On32Hz event mask */
#define LDD_RTC_ON_64_HZ             0x1000U /* On64Hz event mask */
#define LDD_RTC_ON_128_HZ            0x2000U /* On128Hz event mask */
#define LDD_RTC_ON_256_HZ            0x4000U /* On256Hz event mask */
#define LDD_RTC_ON_512_HZ            0x8000U /* On512Hz event mask */
...
typedef struct {                       /* Structure used for time operation */
  ...
  uint32_t DayOfWeek;                  /* day of week (0-Sunday, .. 6-Saturday) or alarm match type */
...
/*
** ===================================================================
** RNGB device types and constants
** ===================================================================
*/
...
** ===================================================================
*/
#define LDD_ivIndex_INITSP                      0x00u
#define LDD_ivIndex_INITPC                      0x01u
#define LDD_ivIndex_Vaccerr                     0x02u
#define LDD_ivIndex_Vadderr                     0x03u
#define LDD_ivIndex_Viinstr                     0x04u
#define LDD_ivIndex_Vdiv_by_zero                0x05u
#define LDD_ivIndex_VReserved6                  0x06u
#define LDD_ivIndex_VReserved7                  0x07u
#define LDD_ivIndex_Vprviol                     0x08u
#define LDD_ivIndex_Vtrace                      0x09u
#define LDD_ivIndex_Vunilaop                    0x0Au
#define LDD_ivIndex_Vunilfop                    0x0Bu
#define LDD_ivIndex_Vdbgi                       0x0Cu
#define LDD_ivIndex_VReserved13                 0x0Du
#define LDD_ivIndex_Vferror                     0x0Eu
#define LDD_ivIndex_VReserved15                 0x0Fu
#define LDD_ivIndex_VReserved16                 0x10u
#define LDD_ivIndex_VReserved17                 0x11u
#define LDD_ivIndex_VReserved18                 0x12u
#define LDD_ivIndex_VReserved19                 0x13u
#define LDD_ivIndex_VReserved20                 0x14u
#define LDD_ivIndex_VReserved21                 0x15u
#define LDD_ivIndex_VReserved22                 0x16u
#define LDD_ivIndex_VReserved23                 0x17u
#define LDD_ivIndex_Vspuri                      0x18u
#define LDD_ivIndex_VReserved25                 0x19u
#define LDD_ivIndex_VReserved26                 0x1Au
#define LDD_ivIndex_VReserved27                 0x1Bu
#define LDD_ivIndex_VReserved28                 0x1Cu
#define LDD_ivIndex_VReserved29                 0x1Du
#define LDD_ivIndex_VReserved30                 0x1Eu
#define LDD_ivIndex_VReserved31                 0x1Fu
#define LDD_ivIndex_Vtrap0                      0x20u
#define LDD_ivIndex_Vtrap1                      0x21u
#define LDD_ivIndex_Vtrap2                      0x22u
#define LDD_ivIndex_Vtrap3                      0x23u
#define LDD_ivIndex_Vtrap4                      0x24u
#define LDD_ivIndex_Vtrap5                      0x25u
#define LDD_ivIndex_Vtrap6                      0x26u
#define LDD_ivIndex_Vtrap7                      0x27u
#define LDD_ivIndex_Vtrap8                      0x28u
#define LDD_ivIndex_Vtrap9                      0x29u
#define LDD_ivIndex_Vtrap10                     0x2Au
#define LDD_ivIndex_Vtrap11                     0x2Bu
#define LDD_ivIndex_Vtrap12                     0x2Cu
#define LDD_ivIndex_Vtrap13                     0x2Du
#define LDD_ivIndex_Vtrap14                     0x2Eu
#define LDD_ivIndex_Vtrap15                     0x2Fu
#define LDD_ivIndex_VReserved48                 0x30u
#define LDD_ivIndex_VReserved49                 0x31u
#define LDD_ivIndex_VReserved50                 0x32u
#define LDD_ivIndex_VReserved51                 0x33u
#define LDD_ivIndex_VReserved52                 0x34u
#define LDD_ivIndex_VReserved53                 0x35u
#define LDD_ivIndex_VReserved54                 0x36u
#define LDD_ivIndex_VReserved55                 0x37u
#define LDD_ivIndex_VReserved56                 0x38u
#define LDD_ivIndex_VReserved57                 0x39u
#define LDD_ivIndex_VReserved58                 0x3Au
#define LDD_ivIndex_VReserved59                 0x3Bu
#define LDD_ivIndex_VReserved60                 0x3Cu
#define LDD_ivIndex_Vunsinstr                   0x3Du
#define LDD_ivIndex_VReserved62                 0x3Eu
#define LDD_ivIndex_VReserved63                 0x3Fu
#define LDD_ivIndex_Virq                        0x40u
#define LDD_ivIndex_Vlvd                        0x41u
#define LDD_ivIndex_Vllwu                       0x42u
#define LDD_ivIndex_Vlol                        0x43u
#define LDD_ivIndex_Vflash                      0x44u
#define LDD_ivIndex_Vdmach0                     0x45u
#define LDD_ivIndex_Vdmach1                     0x46u
#define LDD_ivIndex_Vdmach2                     0x47u
#define LDD_ivIndex_Vdmach3                     0x48u
#define LDD_ivIndex_Vusb0                       0x49u
#define LDD_ivIndex_Vrngb                       0x4Au
#define LDD_ivIndex_Vftm1fault_ovf              0x4Bu
#define LDD_ivIndex_Vftm1ch0                    0x4Cu
#define LDD_ivIndex_Vftm1ch1                    0x4Du
#define LDD_ivIndex_Vftm1ch2                    0x4Eu
#define LDD_ivIndex_Vftm1ch3                    0x4Fu
#define LDD_ivIndex_Vftm1ch4                    0x50u
#define LDD_ivIndex_Vftm1ch5                    0x51u
#define LDD_ivIndex_Vcmp0                       0x52u
#define LDD_ivIndex_Vftm0fault_ovf              0x53u
#define LDD_ivIndex_Vftm0ch0                    0x54u
#define LDD_ivIndex_Vftm0ch1                    0x55u
#define LDD_ivIndex_Vspi0                       0x56u
#define LDD_ivIndex_Vsci0                       0x57u
#define LDD_ivIndex_Vsai_rx                     0x58u
#define LDD_ivIndex_Vsai_tx                     0x59u
#define LDD_ivIndex_Viic0                       0x5Au
#define LDD_ivIndex_Viic2                       0x5Bu
#define LDD_ivIndex_Vspi1                       0x5Cu
#define LDD_ivIndex_Vsci1                       0x5Du
#define LDD_ivIndex_Viic1                       0x5Eu
#define LDD_ivIndex_Viic3                       0x5Fu
#define LDD_ivIndex_Vadc0                       0x60u
#define LDD_ivIndex_Vtsi0                       0x61u
#define LDD_ivIndex_Vdac0                       0x62u
#define LDD_ivIndex_Vcmt                        0x63u
#define LDD_ivIndex_Vpdb0                       0x64u
#define LDD_ivIndex_Vlptmr0                     0x65u
#define LDD_ivIndex_Vlptmr1                     0x66u
#define LDD_ivIndex_VL7swi                      0x67u
#define LDD_ivIndex_VL6swi                      0x68u
#define LDD_ivIndex_VL5swi                      0x69u
#define LDD_ivIndex_VL4swi                      0x6Au
#define LDD_ivIndex_VL3swi                      0x6Bu
#define LDD_ivIndex_VL2swi                      0x6Cu
#define LDD_ivIndex_VL1swi                      0x6Du
#define LDD_ivIndex_Vmtim0                      0x6Eu
#define LDD_ivIndex_Vusbdcd                     0x6Fu
#define LDD_ivIndex_Vportab                     0x70u
#define LDD_ivIndex_Vportdc                     0x71u
#define LDD_ivIndex_Vportfe                     0x72u
