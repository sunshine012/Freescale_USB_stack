...
LDD_USB_TSDP                           pSDP;
extern uint_8 const g_device_descriptor[18];
/*****************************************************************************
* Static Variables
*****************************************************************************/
...
/*
** ===================================================================
**     Method      :  USB_DCI_CallBack (component USB_OTG_STACK)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  USB_DCI_SetAddressCallback (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
/*
** ===================================================================
**     Method      :  USB_DCI_Get_BDT_Index (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
/*
** ===================================================================
**     Method      :  USB_DCI_Validate_Param (component USB_OTG_STACK)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
...
/*
    ** ===================================================================
    **     Method      :  USB_Bus_Reset_Handler (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_OnDeviceSpeedDetect (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_OnDeviceSuspend (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_OnDeviceResume (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_OnDeviceSetupPacket (component USB_OTG_STACK)
    **     Description :
    **         This function called after the setup packet is received into
    **         the internal buffer
**     Parameters  :
**         NAME            - DESCRIPTION
    **       * EpNum       - User data pointer
...
{
    USB_DEV_EVENT_STRUCT event;
    USB_LDD_DeviceReadSetupData(USB_LDD_DevDataPtr, EpNum,&pSDP);
    /* initialize event structure */
    event.controller_ID      = g_dci_controller_Id;
    ...
    case STD_SET_ADDRESS:
        ...
        EPDataTDPtr[EpNum].ParamPtr           = (uint8_t*)(BYTESWAP16(pSDP.wValue));
        event.setup = TRUE;
        /* call service */
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_OnDeviceError (component USB_OTG_STACK)
    **     Description :
    **         This function is called after the Error is detected
**     Parameters  :
**         NAME            - DESCRIPTION
    **       * EpNum       - User data pointer
    **         ErrorSource - Error code
    **         ErrorCode   -
**     Returns     : Nothing
    ** ===================================================================
    */
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_Init (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_DeInit (component USB_OTG_STACK)
    **     Description :
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_Init_EndPoint (component USB_OTG_STACK)
    **     Description :
...
**         NAME            - DESCRIPTION
    ...
    ** ===================================================================
    */
uint_8  USB_DCI_Init_EndPoint(uint_8 controller_ID, USB_EP_STRUCT_PTR ep_ptr, bool flag)
{
    if(ep_ptr->ep_num == CONTROL_ENDPOINT)
    {
        if(ERR_OK != USB_LDD_DeviceInitEndpoint(USB_LDD_DevDataPtr,(LDD_USB_TEpDescriptor *)&g_device_descriptor, (uint8_t)0))
    ...
    else
    {
        ...
        EpDescriptorPtr.wMaxPacketSize = BYTESWAP16((uint_16)ep_ptr->size);
        EpDescriptorPtr.bmAttributes   = ep_ptr->type;
        EpDescriptorPtr.bEndpointAddress = (ep_ptr->direction)<<7|ep_ptr->ep_num;
        if(ERR_OK != USB_LDD_DeviceInitEndpoint(USB_LDD_DevDataPtr,&EpDescriptorPtr,0x00U))
        return USBERR_EP_INIT_FAILED;
        ...
        if(ep_ptr->direction == USB_RECV)
        {
            ...
            USB_LDD_DeviceRecvData(USB_LDD_DevDataPtr,&EPDataTDPtr[ep_ptr->ep_num]);
        }
    }
    return USB_OK;
}
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_Cancel_Transfer (component USB_OTG_STACK)
    **     Description :
    **         This function cancels any pending Transfers which have not
    **         been sent
**     Parameters  :
**         NAME            - DESCRIPTION
...
{
    if(ERR_OK != USB_LDD_DeviceCancelTransfer(USB_LDD_DevDataPtr, endpoint_number, direction<<7))
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_Deinit_EndPoint (component USB_OTG_STACK)
    **     Description :
...
**         NAME            - DESCRIPTION
    ...
    **                       USB_OK                    : When
    **                       Successful
    **                       USBERR_EP_DEINIT_FAILED  : When
    **                       unsuccessful
    ** ===================================================================
    */
uint_8  USB_DCI_Deinit_EndPoint(uint_8 controller_ID, uint_8 ep_num, uint_8 direction)
{
    if(ERR_OK != USB_LDD_DeviceDeinitEndpoint(USB_LDD_DevDataPtr,ep_num,direction<<7))
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_Stall_EndPoint (component USB_OTG_STACK)
    **     Description :
...
{
    USB_LDD_DeviceStallEndpoint(USB_LDD_DevDataPtr, endpoint_number, direction<<7);
}

/*
    ** ===================================================================
    **     Method      :  USB_DCI_Unstall_EndPoint (component USB_OTG_STACK)
    **     Description :
...
{
    USB_LDD_DeviceUnstallEndpoint(USB_LDD_DevDataPtr, endpoint_number, direction<<7);
}

/*
    ** ===================================================================
    **     Method      :  USB_DCI_Get_Setup_Data (component USB_OTG_STACK)
    **     Description :
...
{
    USB_LDD_DeviceReadSetupData(USB_LDD_DevDataPtr,endpoint_number,&pSDP);
}

/*
    ** ===================================================================
    **     Method      :  USB_DCI_Get_Transfer_Status (component USB_OTG_STACK)
    **     Description :
...
{
    return USB_LDD_DeviceGetTransferStatus(USB_LDD_DevDataPtr,endpoint_number,direction<<7);
}

/*
    ** ===================================================================
    **     Method      :  USB_DCI_Recv_Data (component USB_OTG_STACK)
    **     Description :
...
uint_8  USB_DCI_Recv_Data(_usb_device_handle handle, uint_8 endpoint_number, uchar_ptr buffer_ptr, uint_32 size)
{
    ...
    if(size == 0)
    {
        ...
        if(ERR_OK != USB_LDD_DeviceRecvData(USB_LDD_DevDataPtr,&EPDataTDPtr[endpoint_number]))
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_Send_Data (component USB_OTG_STACK)
    **     Description :
...
**         NAME            - DESCRIPTION
    ...
    **                       USB_OK                    : When
    **                       Successful
    **                       USBERR_TX_FAILED : When unsuccessful
    ** ===================================================================
    */
uint_8  USB_DCI_Send_Data(_usb_device_handle handle, uint_8 endpoint_number, uchar_ptr buffer_ptr, uint_32 size)
{
    ...
    EPDataTDPtr[endpoint_number].Head.BufferPtr  = buffer_ptr;
    EPDataTDPtr[endpoint_number].Head.Flags = LDD_USB_DEVICE_TRANSFER_FLAG_EXT_PARAM;
    if(ERR_OK !=USB_LDD_DeviceSendData(USB_LDD_DevDataPtr,&EPDataTDPtr[endpoint_number]))
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_Set_Address (component USB_OTG_STACK)
    **     Description :
    **         This function configures Controller to send data on an SEND
    **         endpoint
**     Parameters  :
...
/*
    ** ===================================================================
    **     Method      :  USB_DCI_Assert_Resume (component USB_OTG_STACK)
    **     Description :
...
{
    (void)USB_LDD_DeviceAssertResume(USB_LDD_DevDataPtr);
}

/*
    ** ===================================================================
    **     Method      :  Clear_Mem (component USB_OTG_STACK)
    **     Description :
