...
$(EXAMPLES_ESCAPED)/hid/mouse/hidmouse.c \
...
Sources/app/hidmouse_c.obj: $(EXAMPLES_ESCAPED)/hid/mouse/hidmouse.c
	@echo 'Building file: $<'
	@echo 'Executing target #30 $<'
	@echo 'Invoking: ARM Compiler'
	"$(ARM_ToolsDirEnv)/mwccarm" -gccinc @@"Sources/app/hidmouse.args" -o "Sources/app/hidmouse_c.obj" -c "$<" -MD -gccdep
	@echo 'Finished building: $<'
	@echo ' '

Sources/app/hidmouse_c.d: $(EXAMPLES_ESCAPED)/hid/mouse/hidmouse.c
	@echo 'Regenerating dependency file: $@'
